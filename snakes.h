 ...
 ** Date:     9/15/2024
 ** This file contains the header file of the snake class
 **********************************************************/
#ifndef SNAKES_H
#define SNAKES_H
#include <iostream>
...
private:
    ...
    void setObs(int placement, int boardSize, int obst, bool type); //helper function for placing snakes/ladders
    void setRandObs(int boardSize, int obst, bool type); //helper function for randomly placing snakes/ladders
    int findSize(Cell * aNode); //helper function to find the size of a given object
    bool snakeTravel(int roll, Cell * start); //helper function to help detirmine if move is valid during testing
